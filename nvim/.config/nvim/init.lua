...
--  See `:help hlsearch`
vim.keymap.set('n', 'nh', '<cmd>nohlsearch<CR>')
...

    {
        ...
        opts = {
            ...
            keymap = {
                ...
                preset = 'none',
                ['<CR>'] = { 'accept', 'fallback' }, -- Accept completion or fallback if none
                ['<C-j>'] = { 'select_next', 'fallback' }, -- Move down
                ['<C-k>'] = { 'select_prev', 'fallback' }, -- Move up
                ['<C-e>'] = { 'hide' }, -- Hide menu
                ['<C-space>'] = { 'show' }, -- Show menu / docs
            },
